...
def parse_args():
    ...
    parser.add_argument("--data_root", type=str, default='None', help="Directory data will be stored.")
    parser.add_argument("--download_celeba", type=bool, default=True, help="Will attempt to download the CelebA dataset."
