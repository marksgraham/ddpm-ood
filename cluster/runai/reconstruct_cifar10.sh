...
runai submit \
  ...
  --model_name=monaigen_cifar10_scaledlinear \
  --validation_ids=/data/data_splits/CIFAR10_val.csv \
  --in_ids=/data/data_splits/CIFAR10_test.csv \
  --out_ids=/data/data_splits/SVHN_test.csv,/data/data_splits/CelebA_test.csv,/data/data_splits/CIFAR10_vflip_test.csv,/data/data_splits/CIFAR10_hflip_test.csv \
  --is_grayscale=0 \
