...
runai submit \
  ...
  --model_name=monaigen_celeba_scaledlinear \
  --validation_ids=/data/data_splits/CelebA_val.csv \
  --in_ids=/data/data_splits/CelebA_test.csv \
  --out_ids=/data/data_splits/SVHN_test.csv,/data/data_splits/CIFAR10_test.csv,/data/data_splits/CelebA_vflip_test.csv,/data/data_splits/CelebA_hflip_test.csv \
  --is_grayscale=0 \
