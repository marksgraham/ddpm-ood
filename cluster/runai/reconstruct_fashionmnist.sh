...
runai submit \
  ...
  --model_name=monaigen_fashionmnist_scaledlinear \
  --validation_ids=/data/data_splits/FashionMNIST_val.csv \
  --in_ids=/data/data_splits/FashionMNIST_test.csv \
  --out_ids=/data/data_splits/MNIST_test.csv,/data/data_splits/FashionMNIST_vflip_test.csv,/data/data_splits/FashionMNIST_hflip_test.csv \
  --is_grayscale=1 \
